# Contributing to assemble-middleware-page-variable

First and foremost, thank you! We appreciate that you want to contribute to assemble-middleware-page-variable, your time is valuable, and your contributions mean a lot to us.
...
**Showing support for assemble-middleware-page-variable**

Please keep in mind that open source software is built by people like you, who spend their free time creating things the rest the community can use.

Don't have time to contribute? No worries, here are some other ways to show your support for assemble-middleware-page-variable:

- star the [project](https://github.com/jonschlinkert/assemble-middleware-page-variable)
- tweet your support for assemble-middleware-page-variable
...
- **version**: please note the version of assemble-middleware-page-variable are you using
...
[so]: http://stackoverflow.com/questions/tagged/assemble-middleware-page-variable